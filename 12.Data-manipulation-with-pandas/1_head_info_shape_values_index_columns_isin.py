...
print(
    homelessness[
        (homelessness["family_members"] > 10000) & (homelessness["region"] == "Pacific")
    ].head()
)

print("\nfiltering rows with isin:")
print(
    homelessness[homelessness["state"].isin(["California", "Texas", "Florida"])].head()
)
...
high_homelessness_srt = homelessness[homelessness["indiv_per_10k"] > 20].sort_values(
