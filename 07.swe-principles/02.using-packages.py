...
from text_analyzer import Document, SocialMedia, Tweets, plot_counter, sum_counters
...
word_counts = [
    ...
    Counter(
        {"@DataCamp": 1, "@ProjectJupyter": 1, "@codingphase": 1, "Mind": 1, "blown": 1}
    ),
    Counter(
        {
            "@DataCamp": 2,
    ...
    Counter(
        {"Advice": 1, "for": 1, "Applying": 1, "to": 1, "#DataScience": 1, "Jobs": 1}
    ),
    ...
    Counter({"@DataCamp": 1, "Thank": 1, "you": 1, "dropped": 1, "an": 1, "email": 1}),
    Counter({"@DataCamp": 1, "#learningR": 1, "#programming": 1, "#datacamp": 1}),
    Counter(
        {
            "@DataCamp": 1,
    ...
    Counter(
        {"@iPablo": 1, "@DataCamp": 1, "Congrats": 1, "keep": 1, "on": 1, "going": 1}
    ),
    Counter(
        {
            "Having": 1,
    ...
    Counter(
        {"@doodssiton": 1, "@DataCamp": 1, "Glad": 1, "to": 1, "hear": 1, "this": 1}
    ),
    Counter(
        {
            "in": 2,
    ...
    Counter({"@Ugyen": 1, "Norbu": 1, "@DataCamp": 1, "Congratulations": 1, "boss": 1}),
    Counter(
        {
            "@DataScienceFEM": 2,
            "RT": 1,
    ...
    Counter({"@iris": 1, "@DataScienceFEM": 1, "@DataCamp": 1, "CONGRAAAAATS": 1}),
    Counter(
        {
            "WE": 1,
            "ARE": 1,
