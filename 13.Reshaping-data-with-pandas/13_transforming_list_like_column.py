...
obesity_final = obesity[["country", "perc_obesity"]].merge(
    obesity_bounds, left_index=True, right_index=True
)
# print(obesity_final)
#      country  perc_obesity bounds
...
obesity_explode.reset_index(
    drop=True, inplace=True
)  # drop=True, the old index is discarded and a fresh RangeIndex is assigned., inplace=True mutates in place
# print(obesity_explode)
#      country  perc_obesity bounds
# 0  Argentina          21.5   15.4
...
obesity_split = obesity.assign(bounds=obesity["bounds"].str.split("-")).explode(
    "bounds"
)
# print(obesity_split)
#         country  perc_obesity bounds
